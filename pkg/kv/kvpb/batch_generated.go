...
func (ru RequestUnion) GetInner() Request {
	...
	case *RequestUnion_GcAndExciseRange:
		return t.GcAndExciseRange
	default:
		return nil
	}
}
...
func (ru ResponseUnion) GetInner() Response {
	...
	case *ResponseUnion_LinkExternalSstable:
		return t.LinkExternalSstable
	case *ResponseUnion_GcAndExciseRange:
		return t.GcAndExciseRange
	default:
		return nil
	}
...
func (ru *RequestUnion) MustSetInner(r Request) {
	...
	case *GCAndExciseRangeRequest:
		union = &RequestUnion_GcAndExciseRange{t}
	default:
...
func (ru *ResponseUnion) MustSetInner(r Response) {
	...
	case *GCAndExciseRangeResponse:
		union = &ResponseUnion_GcAndExciseRange{t}
	default:
		panic(fmt.Sprintf("unsupported type %T for %T", r, ru))
	}
	ru.Value = union
...
type gCAndExciseRangeResponseAlloc struct {
	union ResponseUnion_GcAndExciseRange
	resp  GCAndExciseRangeResponse
}
...
func (ba *BatchRequest) CreateReply() *BatchResponse {
	...
	var buf49 []gCAndExciseRangeResponseAlloc
	...
	for i, r := range ba.Requests {
		...
		case *RequestUnion_GcAndExciseRange:
			if buf49 == nil {
				buf49 = make([]gCAndExciseRangeResponseAlloc, counts[49])
			}
			buf49[0].union.GcAndExciseRange = &buf49[0].resp
...
func CreateRequest(method Method) Request {
	...
	case GCAndExciseRange:
		return &GCAndExciseRangeRequest{}
	default:
